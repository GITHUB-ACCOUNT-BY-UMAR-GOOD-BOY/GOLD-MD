...
smd(
  {
    pattern: "guessage",
    alias: ["age"],
    desc: "Guess The Age With Name Of Person!!.",
    category: "fun",
    use: "guessage [name]",
  ...
  async (message, input) => {
    ...
    if (!name) {
      return message.reply("I Need The Name To Guess Person Age!!");
    }
  ...
  try {
    ...
    if (_0x2bfba9 === "end" && _0x44b37a) {
      if (_0xc06dac) {
        ...
        return await _0x435f9e.reply("*_Number Guessing Game Ended Successfully_*");
      } else {
