  ...
  async (message, input) => {
    try {
      ...
      if (!url || !isValidUrl(url)) {
        return await message.send("*_I Need Spotify URL._*");
      }
      ...
      if (!data || data.status !== 200) {
        return await message.reply("*Error While Downloading Spotify.*");
      }
      ...
      await message.error(error + "\n\nCommand: spotify2", error, "*Error While Downloading Spotify Song.*");
    }
  }
);
...
smd(
  ...
  async (message, input) => {
    try {
      ...
      if (!query) {
        return await message.send("*_Provide Me Text._*");
      }
      ...
      if (!data || data.status !== 200) {
        return await message.reply("*Failed To Found Spotify Task!!!.*");
      }

      const tracks = data.result;
      if (!tracks || tracks.length === 0) {
        return await message.reply("*No Spotify Tracks Founded.*");
      }

      let output = "*GOLD MD SPOTIFY MANAGER:*\n\n";
      ...
      await message.error(error + "\n\nCommand: spotify", error, "*Spotify Founding Error!!*");
    }
  }
);
...
smd({
  ...
  try {
    if (!_0x5614e8) {
      return await _0x47fb55.send("*_Please Provide Me A Text!!!_*");
    }
    let {
      wikimedia: _0x168a95
    } = require("../lib");
...
smd({
  ...
  try {
    ...
    if (_0x48bc12 > 200) {
      return _0x7b09ff.reply("File Size Is Big Upto 200-MB.");
    }
    const _0x31321c = _0x538b40.dllink;
        let _0x24f726 = await fancytext("『 *GOLD MD APK* 』\n\n*🔰APP Name :* " + _0x538b40.name + "\n*🔰App Id :* " + _0x538b40.package + "\n*🔰Last Update :* " + _0x538b40.lastup + "\n*🔰App Size :* " + _0x538b40.size + "\n\n\n " + Config.caption, 25);
    ...
    axios.get(_0x31321c, {
      ...
      ;
      _0x7b09ff.reply("*_Error While Founding Apk_*");
    });
  } catch (_0x4540ef) {
...
cmd({
  ...
  try {
    if (!_0x1cb962) {
      return await _0x19d516.reply("*_Provide Me Apk/Game Name To Download!!!_*");
    }
...
smd({
  ...
  try {
    ...
    if (!response || response.status !== 200) {
      return await msg.reply("*Error Detected While Founding Song-Cloud.*");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x1c586e) {
      return await _0x1ae8f8.reply("*Provide Repo Url, _.gitclone https://github.com/D4X-UMAR_*");
    }
    const _0x5906ab = /(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i;
    if (!_0x5906ab.test(_0x1c586e)) {
      return await _0x1ae8f8.reply("*Provide Me Valid Git Repo!!*");
    }
    ...
    return _0x1ae8f8.error(_0x982fee + "\n\ncommand: gitclone", _0x982fee, "*_Repo Files Not Found!!!_*");
  }
});
...
smd({
  ...
  try {
    const url = query.trim();
    if (!url) {
      return await msg.reply("*I Need Tiktok Video Url!!*");
    }
    ...
    if (!response || response.status !== 200) {
      return await msg.reply("*Error While Founding Tiktok Video!!.*");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x204f81) {
      return _0x55aba2.reply("*_Example : .tts I Am GOLD-MD._*");
    }
    try {
...
smd({
  ...
  try {
    ...
    if (!_0x53783b || !_0x53783b.toLowerCase().startsWith("http")) {
      return _0x272f8d.reply("*_Provide Me Video Url, " + prefix + "downmp4 https://telegra.ph/file/d90855d13352c8aae3981.mp4_*");
    }
    ...
    await _0x272f8d.error(_0x2306b6 + "\n\ncommand : downmp4", _0x2306b6, "*_Provide Me Valid Video Url_*");
  }
});
smd({
  pattern: "video",
  ...
  try {
    ...
    var _0x3048ab = {
      ...(await _0xe5ea97.bot.contextInfo(Config.botname, "🔰GOLD🔰MD🔰VIDEO🔰DOWNLOADER🔰"))
    };
    let _0x3d0cf7 = {
    ...
    try {
      ...
      let _0x3448d2 = _0x4e4465.title || _0x3e3caf || _0x421809[1] || "GOLD-MD -- YT";
      if (_0x3e3caf) {
        ...
        await _0xe5ea97.send("Your Video not Found Sorry!!!");
      }
      try {
        fs.unlinkSync("" + _0x3e3caf);
      } catch {}
    } catch (_0x55db8f) {
      return _0xe5ea97.error(_0x55db8f + "\n\ncommand: video", _0x55db8f, "*_Error Video not Found_*");
    }
  }
});
smd({
  ...
  try {
    ...
    var _0x1e7392 = {
      ...(await _0xf4a47.bot.contextInfo(Config.botname, "🔰GOLD🔰MD🔰VIDEO🔰DOWNLOADER🔰"))
    };
    if (_0x2b6ac2) {
      ...
      await _0xf4a47.send("Video Not Found Sorry!!");
    }
    try {
...
smd({
  ...
  try {
    ...
    if (!_0x25d045) {
      return _0x54463e.reply("*" + prefix + "play Sohne Nabiya Da Nabi Tu Imam Sohniya Naat*");
    }
    ...
    if (_0x6845ab && _0x6845ab.duration >= videotime) {
      return await _0x54463e.reply("*_Can't dowanload, Sorry!!_*");
    }
    ...
    var _0x28302f = {
      ...(await _0x54463e.bot.contextInfo(Config.botname, "🔰GOLD🔰MD🔰AUDIO🔰DOWNLOADER🔰"))
    };
    if (_0x37323e) {
      ...
      _0x54463e.send("*_Error Video not Found Sorry_*");
    }
    try {
      fs.unlinkSync(_0x37323e);
    } catch {}
  } catch (_0x593953) {
    return _0x54463e.error(_0x593953 + "\n\ncommand: play", _0x593953, "*_Video not Found, Sorry!!_*");
  }
});
smd({
  pattern: "sound",
  ...
  try {
    ...
    var _0x29fdd9 = {
      ...(await _0x2ee3dd.bot.contextInfo(Config.botname, "🔰GOLD🔰MD🔰TIKTOK🔰DOWNLOADER🔰 " + _0x19c223))
    };
    let _0x4737bb = {
      audio: _0x2ba501,
...
smd({
  ...
  try {
    ...
    if (!/tiktok/.test(tiktokUrl)) {
      return await message.reply("*Provide Me A Valid Tiktok Video Url!*");
    }
    ...
    if (data && data.video && data.video.noWatermark) {
      ...
      return await message.reply("Error By Downloading Tiktok Video");
    }
  } catch (error) {
...
smd({
  ...
  try {
    ...
    var _0x2e165b = {
      ...(await _0x1da3da.bot.contextInfo(Config.botname, "🔰GOLD🔰MD🔰RINGTONE🔰DOWNLOADER🔰"))
    };
    let _0x5c9751 = {
      audio: {
...
smd({
  ...
  try {
    if (!_0x589f9c) {
      return _0xf8b0b.reply("I Need The Image Name To Found On Pinterest !!");
    }
    let _0x383852 = (await pinterest(_0x589f9c)) || [];
    if (!_0x383852 || !_0x383852[0]) {
      return await _0xf8b0b.send("*_I Can't Find Anything Please Try Again!_*");
    }
    var _0x132d25 = {
      ...(await _0xf8b0b.bot.contextInfo(Config.botname, "🔰GOLD🔰MD🔰PINTEREST🔰DOWNLOADER🔰"))
    };
    ...
    return _0xf8b0b.reply("Uhh Plese, Give me a Name. Ex .pint Pakistani Flag");
  }
});
smd({
  pattern: "mediafire",
  ...
  try {
    ...
    if (!_0x15a389 || !_0x15a389[0]) {
      return _0x1ccf8b.reply("Error Please Try Again Later !!");
    }
    let _0x504ec3 = "『 *GOLD MD MEDIAFIRE DOWNLOADER* 』\n\n *🔰Name* : " + _0x15a389[0].nama + "\n *🔰Size* :" + _0x15a389[0].size + "\n *🔰Mime* : " + _0x15a389[0].mime + "\n \n\n" + Config.caption;
    ...
    return _0x1ccf8b.error(_0x50b778 + "\n\ncommand: mediafire", _0x50b778, "*_Error File Not Found Sorry!!_*");
  }
});
smd({
  pattern: "song",
  ...
  try {
    if (!_0x4ec99f) {
      return await _0x2c2023.reply("*_Provide Me A Text_*");
    }
    let _0x3b2ca6 = await yts(_0x4ec99f);
    let _0x4123ae = _0x3b2ca6.all[0];
    let _0x5883a9 = "\t *🔰GOLD🔰MD🔰SONG🔰DOWNLOADER🔰*   \n\n*Title :* " + _0x4123ae.title + "\nUrl : " + _0x4123ae.url + "\n*🔰Description :* " + _0x4123ae.timestamp + "\n*🔰Views :* " + _0x4123ae.views + "\n*🔰Uploaded :* " + _0x4123ae.ago + "\n*Author :* " + _0x4123ae.author.name + "\n\n\n_Tyoe 1 To Download Video_ Or _1 document_\n_Type 2 To Download Audio_ Or _2 document_";
    let _0x3885cc = await smdBuffer(_0x4123ae.thumbnail);
    var _0x44a363 = {
      ...(await _0x2c2023.bot.contextInfo(Config.botname, 🔰GOLD🔰MD🔰YT-SONG🔰DOWNLOADER🔰", _0x3885cc))
    };
...
smd({
  ...
  try {
    ...
    try {
      ...
      var _0x3b1bff = {
        ...(await _0x1d4717.bot.contextInfo(Config.botname, "🔰GOLD🔰MD🔰YOUTUBE🔰"))
      };
...
smd({
  ...
  if (!_0x4fe91c || !_0x2758ec[0]) {
    return await _0x3f8930.reply("*_I Need Youtube Video Url To Doenload The In Audio_*");
  }
  try {
    ...
    var _0x29af08 = {
      ...(await _0x3f8930.bot.contextInfo(Config.botname, "🔰GOLD🔰MD🔰YOUTUBE🔰"))
    };
    let _0x4c646c = {
    ...
    try {
      ...
      await _0x3f8930.error(_0x2cd979 + "\n\ncommand: ytmp3", _0x2cd979, "*_Audio Not Found Sorry!!_*");
    }
  }
});
smd({
  ...
  try {
    ...
    if (!_0x5696a7 || !_0x1d542b[0]) {
      return await _0x17c662.reply("Provide Me A Valid Url");
    }
    ...
    if (!_0x59bbaa) {
      return await _0x17c662.send("*_Video Not Found Sorry!!_*");
    }
    var _0x10e2fa = {
...
cmd({
  ...
  if (_0xb75e78.quoted && _0xb75e78.text) {
    ...
    if (_0x5b8ee5[0].includes("🔰GOLD🔰MD🔰SONG🔰DOWNLOADER🔰")) {
      ...
      try {
        ...
        return await _0xb75e78.reply("Error While Downloading Video Please Try Again: " + _0x189dd8);
      }
    } else if (_0x5b8ee5[0].includes("🔰GOLD🔰MD🔰YOUTUBE🔰DOWNLOADER🔰")) {
    ...
    } else if (_0x5b8ee5[0].includes("🔰GOLD🔰MD🔰APK🔰DOWNLOADER🔰")) {
      ...
      if (_0x205a5f) {
        try {
          ...
          _0xb75e78.reply("*_Apk Not Downloaed Because Apk MB'S Size Too Large_*");
        }
      }
    }
  }
