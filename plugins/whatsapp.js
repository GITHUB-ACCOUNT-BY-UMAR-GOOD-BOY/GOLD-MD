  ...
  async (_0x4f9f9f) => {
    try {
      ...
      if (!_0x3d8b6f || !mtypes.includes(_0x3d8b6f?.mtype || "need_Media")) {
        return await _0x4f9f9f.reply("*I Need Image!!*");
      }
  ...
  async (_0x36432c) => {
    try {
      ...
      if (!_0x312b1b || !mtypes.includes(_0x312b1b?.mtype || "need_Media")) {
        return await _0x36432c.reply("*Give Me An Imager*");
      }
      return await updateProfilePicture(
        _0x36432c,
        _0x36432c.user,
...
smd(
  ...
  async (_0x1c9bb5) => {
    try {
      ...
      _0x1c9bb5.send("*_Profile Picture Has Been Removed Successfully_*");
    } catch (_0x385cbc) {
    ...
    try {
      if (!_0xb45f41) {
        return await _0xd700b1.send(
          "*_Type A Name To Update Your About!_*\n*_Example: " +
            prefix +
            "bio GOLD MD WAS CREATED BY UMAR_*"
        );
      }
      await _0xd700b1.bot.updateProfileStatus(_0xb45f41);
      _0xd700b1.send("*Successfully Updated!*");
    } catch (_0x365d42) {
...
cmd(
  ...
  async (_0x235a20, _0x3f96d6, { cmdName: _0x31c746 }) => {
    try {
      if (!_0x235a20.quoted) {
        return await _0x235a20.send("*I Need The Video*");
      }
      let _0x109aee = _0x235a20.quoted.mtype;
      if (_0x109aee !== "videoMessage") {
        return await _0x235a20.send("*Reply To Video Msg*");
      }
...
cmd(
  ...
  async (_0x23a729, _0x5ad999, { cmdName: _0x2cb44f }) => {
    try {
      ...
      if (!_0x48ef43) {
        return await _0x23a729.send("*Reply To Any Msg*");
      }
    ...
    try {
      ...
      if (_0x2c7cd9.length === 0) {
        return await _0x48a6fc.reply(
          "You Don't Have Any Blocked Numbers."
        );
      }
      let _0x50c0a6 =
        "\n*≡ List*\n\n*_Total Users:* " +
  ...
  async (_0x1de930, _0x4113fc) => {
    try {
      ...
      await _0x1de930.reply(
        "*----------LOCATION------------*\n```GOLD MD IS SENDING LOCATION TO GIVEN DATE:\n Latitude: " +
          _0x1622ee +
          "\n Longitude: " +
          _0x4c75f7 +
          "```\n\n" +
  ...
  async (_0xc7dd0, _0x22efeb, { store: _0x1c364d }) => {
    try {
      ...
      return await _0xc7dd0.error(
        _0x5752f9 + "\n\n command: listpc",
        _0x5752f9,
        "*_Sorry I Can't Get Any Results Please Try Again Later!!!_*"
      );
    }
  }
);
  ...
  async (_0x281fb2, _0x20e08d, { store: _0x7945b9, Void: _0x274b4e }) => {
    try {
      ...
      return await _0x281fb2.error(
        _0x5633d6 + "\n\n command: listpc",
        _0x5633d6,
        "*_I Can't Get Any Result Please Try Again!!!_*"
      );
    }
  }
);
    ...
    try {
      let _0x329b9f =
        _0x1afa64.reply_message && _0x1afa64.reply_message.fromMe
          ...
          : false;
      if (!_0x329b9f) {
        return await _0x1afa64.reply("_Reply To Your Msg To Edit!_");
      }
      if (!_0x539d95) {
        return await _0x1afa64.reply("_Need text, Example: edit I'M GOLD MD WHATSAPP BOT WAS CREATED BY UMAR_");
      }
