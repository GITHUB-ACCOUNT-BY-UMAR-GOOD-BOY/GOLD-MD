  ...
  async (_0xf78029) => {
    ...
    if (!_0x10bccf || !_0x204a80 || !_0x204a80[0]) {
      return await _0xf78029.reply(
        "*There's no Sudo added In your bot!*"
      );
    }
    let _0x762894 = (
      "\n   🔰 *" +
      (Config.botname ? Config.botname : "GOLD-MD ") +
      " SUDOS* 👤\n   \n" +
      _0x10bccf
    ).trim();
    return await _0xf78029.reply(
      "https://i.ibb.co/h1X15fV/Gold-Pic-83837619797633e2hshghshshdhxhxjd846431955594613jsksosjejsjsjsjsj-Gold-Pic-jsksjdjxjd7949735.png",
      {
        caption: _0x762894,
        mentions: _0x1babe2,
      },
  ...
  async (_0x61d6ff) => {
    try {
      ...
      if (!_0x24d586 || !_0x24d586.includes("@s.whatsapp.net")) {
        return await _0x61d6ff.reply("*Reply To A User*");
      }
      let _0xf1255f = _0x24d586.split("@")[0];
      if (global.sudo.includes(_0xf1255f)) {
        return _0x61d6ff.reply("*Number Already Added In Sudo!*");
      }
  ...
  async (_0xd149b4) => {
    try {
      ...
      if (!_0x45285f || !_0x45285f.includes("@s.whatsapp.net")) {
        return await _0xd149b4.reply("*Reply To A User*");
      }
      ...
      if (global.sudo.includes(_0x5a3afd)) {
        ...
        return await _0xd149b4.reply("*_This User Is Not Found In Your Bot SUDO'S!_*");
      }
    ...
    try {
      if (!_0x5eb901) {
        return _0x23a9e4.reply(
          "*Type " + (prefix + _0x5d321d) + " BOT_NAME:GOLD MD BY UMAR*"
        );
      }
