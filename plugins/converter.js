  ...
  async (_0x5f0a63) => {
    try {
      ...
      if (_0x4a2c9b && mtypes.includes(_0x4a2c9b?.mtype || "need_Media")) {
        ...
        return _0x5f0a63.reply("*_Reply To Image/Video_*");
      }
    } catch (_0xb1d121) {
  ...
  async (_0x471740, _0x3febcd) => {
    try {
      ...
      if (!_0xad98fb || _0xad98fb?.mtype != "stickerMessage") {
        return await _0x471740.reply("*Reply To Any Sticker*");
      }
      let _0x44d3dd = _0x3febcd.split("|");
      let _0x47c982 =
        _0x44d3dd[0]?.trim() !== "" ? _0x44d3dd[0] : _0x471740.pushName;
      let _0x20f704 =
        _0x44d3dd[1] && _0x44d3dd[1] !== "" ? _0x44d3dd[1] : "GOLD-MD 🔰";
    ...
    try {
      let _0x128f40 = await smdBuffer(
        "https://raganork-api.onrender.com/api/attp?text=" +
          (_0x3444c7 ? _0x3444c7 : "I Need The Text To Create Animated Sticker Ex:- attp UMAR") +
  ...
  async (_0x50fc92) => {
    try {
      ...
      if (_0x2d0760 && mtypes.includes(_0x2d0760?.mtype || "need_Media")) {
        ...
        return _0x50fc92.reply("*_I Need The Image!!_*");
      }
    } catch (_0x1c7f0b) {
      return await _0x50fc92.error(
        _0x1c7f0b + "\n\ncmdName: crop\n",
        "*_Error!! Please Try Again Later!_*"
      );
    }
  }
);
  ...
  async (_0x52caf7) => {
    try {
      ...
      if (_0x11d586 && mtypes.includes(_0x11d586?.mtype || "need_Media")) {
        ...
        return _0x52caf7.reply("*_I Need The Image Provide Me Any Image!!_*");
      }
    } catch (_0x165b2a) {
      return await _0x52caf7.error(
        _0x165b2a + "\n\ncmdName: circle\n",
        "*_Error Detected Please Try Again Later!!!_*"
      );
    }
  }
);
  ...
  async (_0x37c100) => {
    try {
      ...
      if (_0x5f32a5 && mtypes.includes(_0x5f32a5?.mtype || "need_Media")) {
        ...
        return _0x37c100.reply("*_Reply To Any Image!!_*");
      }
    } catch (_0x52baa5) {
...
smd(
  ...
  async (_0x29b369, _0x406491) => {
    try {
      ...
      if (!_0x406491) {
        return await _0x29b369.reply("*Provide Me Any Text*");
      }
      if (!_0x5b20bd || !pmtypes.includes(_0x5b20bd.mtype)) {
        return _0x29b369.reply("*Reply To Image *");
      }
  ...
  async (_0x46e4d3, _0x5dee47) => {
    try {
      ...
      if (!_0x41bce8 || _0x41bce8?.locale == "") {
        return _0x46e4d3.send("*_Error While Mixing Emojies Please Try Again!!!_*");
      } else {
  ...
  async (_0xa1cfa2, _0x4ec923) => {
    try {
      ...
      if (!_0x5a2037 || !_0x8d0e84) {
        return _0xa1cfa2.reply("*_Provide Me Msg!!!_*");
      }
      ...
      if (
        ...
        !_0x51ed20.data.ok
            ...
            return await _0xa1cfa2.send("*_Can't Create Your Sticker Please Try Again!_*");
      }
...
smd(
  ...
  async (_0x230c03, _0x3b568a) => {
    try {
      let _0x365550 =
        "GOLD MD FANCY TEXT GENERATOR " +
        (_0x3b568a
          ? "```🔰Reply the number you wants to select``` \n\n"
          : "```\t\t" +
            prefix +
            "fancy UMAR(For all text)\n\t\t" +
            prefix +
            "fancy 25 UMAR(For specific text)```\n\n");
      let _0x50c7d9 = parseInt(_0x3b568a);
      if (isNaN(_0x50c7d9)) {
        let _0x4ca942 = _0x3b568a ? _0x3b568a : "GOLD";
  ...
  async (_0x85089c, _0x29ac4f) => {
    try {
      if (!_0x29ac4f || !_0x29ac4f.toLowerCase().includes("https")) {
        return _0x85089c.reply("Give Me Any Link Ex:- tiny https://github.com/D4X-UMAR");
      }
      let _0xe54a62 = _0x29ac4f.split(" ")[0];
      let _0x24899a = await axios.get(
        "https://tinyurl.com/api-create.php?url=" + _0xe54a62
      );
      _0x85089c.reply("*Your Link Has Been Shorted🔰*\n\n" + _0x24899a.data);
    } catch (_0x39ae7e) {
...
smd(
  ...
  async (_0x19c21a, _0xc7f8c4) => {
    try {
      if (!_0xc7f8c4) {
        return _0x19c21a.reply("*I Need Text To Create QR!*");
      }
      let _0x494bbd =
  ...
  async (_0x31d7b) => {
    try {
      ...
      if (!_0xd092ed || !pmtypes.includes(_0xd092ed?.mtype)) {
        return _0x31d7b.reply("*_Reply Any Sticker To Make Image.!!_*");
      }
  ...
  async (_0x116242) => {
    try {
      ...
      if (!_0x2976f2 || !audtypes.includes(_0x2976f2?.mtype)) {
        return _0x116242.reply("*_Reply To Any Video To Create Audio!!_*");
      }
  ...
  async (_0x5c9aa3) => {
    try {
      ...
      if (!_0x462db2 || !audtypes.includes(_0x462db2?.mtype)) {
        return _0x5c9aa3.reply("*_Provide Me Any Video/Audio_*");
      }
  ...
  async (_0x4ed07c) => {
    ...
    if (!_0xadff0d) {
      return _0x4ed07c.reply(
        "*_Reply To Animated Sticker Or Gif!!_*"
      );
    }
    ...
    if (_0xadff0d?.mtype != "videoMessage" && !/webp/.test(_0x4ab6cb)) {
      return await _0x4ed07c.send(
        "*Reply To An Animated Sticker or Gif *"
      );
    }
    ...
    try {
      try {
        ...
        console.log("Error Converting Please Try Again Later!!\n", _0x1b8bba);
      }
