...
let antiCallMessage =
  ...
  "```Hey!! I'm Bussy At The Moment Please Don't Call me I will Reply You Soon....```";
...
smd(
  ...
  async (_0x3079c3, _0x16cfc8) => {
    ...
    if (
      ...
      if (_0x20f464[_0x4fb4e6(482)] === _0x4fb4e6(448)) {
        return await _0x3079c3[_0x4fb4e6(455)](
          "*ANTI-CALL CURRUNTLY DE-ACTIVATED*"
        );
      }
      ...
      return await _0x3079c3[_0x4fb4e6(455)]("*ANTI-CALL IS NOW DE-ACTIVATED SUCCESSFULLY*");
    } else if (!_0x16cfc8) {
    ...
    if (!_0x16cfc8 || !_0x550952) {
      ...
      return await _0x3079c3[_0x4fb4e6(455)](
        _0x4fb4e6(473) + prefix + "anticall all,212,,92_*"
      );
    }
  }
);
  ...
  async (_0x24b8a0) => {
    try {
      ...
      try {
        ...
        return _0x24b8a0.reply("```Error While Founding Profile Pic```");
      }
      ...
      if (!_0x354e18 && _0x5b9714.isGroup) {
        const _0x561b75 =
          (await _0x5b9714.bot
            ...
            .catch(
              (_0x1c3876) => "https://i.ibb.co/h1X15fV/Gold-Pic-83837619797633e2hshghshshdhxhxjd846431955594613jsksosjejsjsjsjsj-Gold-Pic-jsksjdjxjd7949735.png"
            )) || THUMB_IMAGE;
        ...
        if (!_0x354e18) {
          return _0x5b9714.reply("*_Mention To Any Member!_*");
        }
        try {
        ...
        try {
          ...
          _0x5ae446 = "https://i.ibb.co/h1X15fV/Gold-Pic-83837619797633e2hshghshshdhxhxjd846431955594613jsksosjejsjsjsjsj-Gold-Pic-jsksjdjxjd7949735.png";
        }
    ...
    try {
      ...
      if (_0x649c1d === "on" || _0x649c1d === "enable" || _0x649c1d === "act") {
        if (bgmm.antidelete === "true") {
          return await _0x17cbbb.reply("*Anti_Delete Is Disabled!!*");
        }
        ...
        return await _0x17cbbb.reply("*Anti_Delete Is Now Enabled*");
      } else if (
        _0x649c1d === "off" ||
        _0x649c1d === "disable" ||
        _0x649c1d === "deact"
        ...
        if (bgmm.antidelete === "false") {
          return await _0x17cbbb.reply("*Anti_Delete Already Off*");
        }
        await bot_.updateOne(
          {
            id: "bot_" + _0x17cbbb.user,
        ...
        return await _0x17cbbb.reply("*Anti_Delete Succesfully De-Activated*");
      } else {
        return await _0x17cbbb.send(
          "*_Type on/off to enable/disable Anti_DeleteIn Currunt Chat!!_*"
        );
      }
    } catch (_0x29fc10) {
  ...
  async (_0x4dc028, _0x422147, { store: _0x205c9c }) => {
    try {
      ...
      if (!_0x4dc028.isBotAdmin) {
        return await _0x4dc028.send("Give An Admin Role To Me First!!!");
      }
